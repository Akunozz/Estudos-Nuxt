    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/" class="flex ms-2 md:me-24">
          <img src="/img/logo.png" class="h-8" alt="Frota Certa Logo" />
        </a>
      </div>
      <div class="flex items-center roud">
          <div class="flex items-center ms-3">
            ...
            <div class="z-50 hidden w-56 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-2xl shadow-sm dark:bg-gray-700 dark:divide-gray-500" id="dropdown-user">
              <div class="p-4 flex items-center space-x-3" role="none">
              ...
              <ul class="" role="none">
                ...
                <li class="pt-2">
               <a href="#"
                  class="flex items-center px-5 py-3 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Settings</span>
               </a>
            </li>
             ...
             <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Pricing</span>
               </a>
            </li>
            ...
            <li class="pb-2">
               <a href="#"
                ...
                <li class="border-t border-gray-100 dark:border-gray-500"></li>
