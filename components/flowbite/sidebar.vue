...
// Computa as classes do sidebar dinamicamente
const sidebarClasses = computed(() => {
  return isCollapsed.value
    ? "fixed top-0 left-0 z-40 w-20 h-screen pt-20 transition-all bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700"
    : "fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-all bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700";
});
...
<aside id="logo-sidebar" :class="sidebarClasses" aria-label="Sidebar">
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
         <button 
            type="button" 
            @click="toggleSidebar"
            class="absolute right-4 top-16 text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left-to-line">
               <path d="M3 19V5"/>
         ...
         <ul class="space-y-2 font-medium">
            <li>
               ...
               <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span v-show="!isCollapsed" class="ms-3">Home</span>
               </a></NuxtLink>
            </li>
            ...
            <li>
               <NuxtLink to="/loginPage">
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Login Page</span>
               </a>
            </NuxtLink>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Usuários</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Empresas</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Centro de custo</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Módulos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Checklist</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clipboard-type"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M9 12v-1h6v1"/><path d="M11 17h2"/><path d="M12 11v6"/></svg>
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Tipos de Checklist</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Itens</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Itens status</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Grupos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Modelos de Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed" class="flex-1 ms-3 whitespace-nowrap text-sm">Marcas de Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span v-show="!isCollapsed"class="flex-1 ms-3 whitespace-nowrap text-sm">Motoristas</span>
               </a>
            </li>
