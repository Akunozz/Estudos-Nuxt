...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-700 dark:border-gray-700" aria-label="Sidebar">
         ...
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <NuxtLink to="/loginPage">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Login Page</span>
               </a>
            </NuxtLink>
            </li>
            ...
            <li>
               ...
               <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Usuários</span>
               </a>
            </NuxtLink>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Empresas</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Centro de custo</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Módulos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Checklist</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Tipos de Checklist</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Itens</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Itens status</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Grupos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Modelos de Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Marcas de Veículos</span>
               </a>
            </li>
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-sm">Motoristas</span>
               </a>
            </li>
